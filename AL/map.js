(function (config) {
    ...
    config.wg = "1536672475627";
    var Zb = window.AMap.TC = {},
        mc = config[2].split(",")[0],
        nc = mc + "/theme/v" + config[4] + "/style1536672475627.css",
    ...
    function rc() {
        for (var a = mc + "/maps/main?v=" + config[4] + "&key=" + config[0] + "&m=" + config.AN.join(",") + "&vrs=1536672475627", b = document.getElementsByTagName("script"), c, d = 0; d < b.length; d += 1)
...
})(["1994ba35a603f806df16000f3799b1da", [115.423411, 39.442758, 117.514625, 41.060816, 116.405285, 39.904989], "http://webapi.amap.com", 1, "1.3", null, "110000", "", true, true, true, true, "1550583208-1"])